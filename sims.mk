...
test-sim-custom-genesis-fast:
	...
	@go test -mod=readonly $(SIMAPP) -run TestFullIrisSimulation -Genesis=${HOME}/.fury/config/genesis.json \
...
test-sim-custom-genesis-multi-seed: runsim
	...
	@echo "By default, ${HOME}/.fury/config/genesis.json will be used."
	@$(BINDIR)/runsim -Jobs=4 -Genesis=${HOME}/.fury/config/genesis.json 400 5 TestFullIrisSimulation
