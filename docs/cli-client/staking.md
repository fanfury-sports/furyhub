...
```bash
fury query staking delegation <furyaa...> <iva...>
```
...
```bash
Delegation:
  Delegator:  furyaa13lcwnxpyn2ea3skzmek64vvnp97jsk8qrcezvm
  Validator:  furyva15grv3xg3ekxh9xrf79zd0w077krgv5xfzzunhs
...
```bash
fury query staking delegations <furyaa...>
```
...
Delegation:
  Delegator:  furyaa13lcwnxpyn2ea3skzmek64vvnp97jsk8qrcezvm
  Validator:  furyva1yclscskdtqu9rgufgws293wxp3njsesxxlnhmh
  Shares:     100.0000000000000000000000000000
  Height:     0
Delegation:
  Delegator:  furyaa1td4xnefkthfs6jg469x33shzf578fed6n7k7ua
  Validator:  furyva1yclscskdtqu9rgufgws293wxp3njsesxxlnhmh
  Shares:     1.0000000000000000000000000000
  Height:     26
```
...
```bash
fury query staking unbonding-delegation <furyaa...> <iva...>
```
...
```bash
fury query staking unbonding-delegations <furyaa...>
```
...
```bash
fury query staking redelegation <furyaa...> <iva...> <iva...>
```
...
```bash
fury query staking redelegations <furyaa...>
```
