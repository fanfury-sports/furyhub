...
```bash
fury tx bank send furyaa1w9lvhwlvkwqvg08q84n2k4nn896u9pqx93velx furyaa15uys54epmd2xzhcn32szps56wvev40tt908h62 10fury --chain-id=furyhub --generate-only
```
        ...
        "msg": [
            {
                ...
                "value": {
                    "from_address": "furyaa1w9lvhwlvkwqvg08q84n2k4nn896u9pqx93velx",
                    "to_address": "furyaa15uys54epmd2xzhcn32szps56wvev40tt908h62",
                    "amount": [
                        {
                            "denom": "fury",
                            "amount": "10"
        ...
        "msg": [
            {
                ...
                "value": {
                    "inputs": [
                        {
                            "address": "furyaa106nhdckyf996q69v3qdxwe6y7408pvyvyxzhxh",
                            "coins": [
                                {
                                    "denom": "ufury",
                                    "amount": "1000000"
                    ...
                    "outputs": [
                        {
                            "address": "furyaa1893x4l2rdshytfzvfpduecpswz7qtpstevr742",
                            "coins": [
                                {
                                    "denom": "ufury",
                                    "amount": "1000000"
...
```bash
fury query txs --events 'message.sender=<furyaa...>&message.action=xxxx' --page 1 --limit 30
```
