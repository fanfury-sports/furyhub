...
func TestMsgAddSuperGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"furyhub/guardian/MsgAddSuper","value":{"added_by":"furyaa1pgm8hyk0pvphmlvfjc8wsvk4daluz5tgarmkm5","address":"furyaa1n7rdpqvgf37ktx30a2sv2kkszk3m7ncmw5r234","description":"description"}}`
...
func TestMsgDeleteSuperGetSignBytes(t *testing.T) {
	msg := NewMsgDeleteSuper(testAddr, sender)
	res := msg.GetSignBytes()
	expected := `{"type":"furyhub/guardian/MsgDeleteSuper","value":{"address":"furyaa1n7rdpqvgf37ktx30a2sv2kkszk3m7ncmw5r234","deleted_by":"furyaa1pgm8hyk0pvphmlvfjc8wsvk4daluz5tgarmkm5"}}`
	require.Equal(t, expected, string(res))
}
